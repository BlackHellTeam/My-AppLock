...
public class LewaScreenListenerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        LewaAppLockHelper mLockDB = new LewaAppLockHelper(context);
        ...
        if ((Intent.ACTION_BOOT_COMPLETED).equals(action)) {
            context.startService(new Intent(context, LewaAppLockService.class));
