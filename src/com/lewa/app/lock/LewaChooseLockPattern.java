 ...
 */
public class LewaChooseLockPattern extends PreferenceActivity {
    ...
    public Intent getIntent() {
        ...
        modIntent.putExtra(EXTRA_SHOW_FRAGMENT,
                LewaChooseLockPatternFragment.class.getName());
        modIntent.putExtra(EXTRA_NO_HEADERS, true);
        return modIntent;
    }
    protected boolean isValidFragment(String fragmentName) {
        if (LewaChooseLockPatternFragment.class.getName().equals(fragmentName))
            return true;
        return false;
    }
    @Override
    ...
    public static class LewaChooseLockPatternFragment extends Fragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mModifyString = intent.getStringExtra("com.lewa.app.lock.MODIFY_PASSWORD");
        }
        ...
        private void saveChosenPatternAndFinish() {
            ...
            utils.saveLewaAppLockPattern(mChosenPattern);
            if (mModifyString == null) {
                Intent intent = new Intent();
                intent.setClassName("com.lewa.app.lock",
                      "com.lewa.app.lock.LewaAppLockActivity");
