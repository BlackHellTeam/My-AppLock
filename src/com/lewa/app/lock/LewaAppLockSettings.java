...
public class LewaAppLockSettings extends PreferenceActivity {
    @Override
    public Intent getIntent() {
        Intent modIntent = new Intent(super.getIntent());
        modIntent.putExtra(EXTRA_SHOW_FRAGMENT,
                LewaAppLockSettingsFragment.class.getName());
    ...
    protected boolean isValidFragment(String fragmentName) {
        if (LewaAppLockSettingsFragment.class.getName().equals(fragmentName)) return true;
        return false;
    }

    public static class LewaAppLockSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.lewa_applock_settings);
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            if (preference == mAppLockSwitchPreference) {
                ...
                newIntent.setClassName("com.lewa.app.lock",
                        "com.lewa.app.lock.LewaChooseLockPattern");
                newIntent.putExtra("com.lewa.app.lock.MODIFY_PASSWORD",
                        "modify_password");
        ...
        private void updatePreference() {
            boolean lockValue = Settings.System.getInt(getActivity()
                    .getContentResolver(),
                    ExtraSettings.System.LEWA_APPLOCK_ENABLED, 1) == 1 ? true
                    : false;
        ...
        private void setPreference(boolean isChecked) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    ExtraSettings.System.LEWA_APPLOCK_ENABLED, isChecked ? 1
                            : 0);
        }

        private void setPatternVisible(boolean isChecked) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    "lewa_applock_pattern_visible", isChecked ? 1 : 0);
        }

        private void setPatternFeedBack(boolean isChecked) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    "lewa_applock_feedback", isChecked ? 1 : 0);
        }
    }
